...
Page({
  data: {
    ...
    rankingList: [
      ...
      {
        avatarUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=user%20avatar%207&image_size=square',
        nickName: '好友2',
        score: 500
      },
      {
        avatarUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=user%20avatar%208&image_size=square',
        nickName: '好友3',
        score: 450
      },
      {
        avatarUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=user%20avatar%209&image_size=square',
        nickName: '好友4',
        score: 400
      },
      {
        avatarUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=user%20avatar%2010&image_size=square',
        nickName: '好友5',
        score: 350
      }
    ],
  ...
  checkCheckinStatus() {
    ...
    const lastCheckin = wx.getStorageSync('lastCheckinFeiyi');
  ...
  checkin() {
    ...
    setTimeout(() => {
      const today = new Date().toDateString();
      wx.setStorageSync('lastCheckinFeiyi', today);
  ...
  startQuiz() {
    ...
    wx.navigateTo({
      url: '/pages/feiyi/quiz/quiz?type=daily'
    });
  },

  startChallenge() {
    wx.navigateTo({
      url: '/pages/feiyi/quiz/quiz?type=challenge'
    });
  },

  startGuess() {
    wx.navigateTo({
      url: '/pages/feiyi/quiz/quiz?type=guess'
    });
  },
