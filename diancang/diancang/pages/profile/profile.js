...
Page({
  data: {
    ...
    rankingList: [
      {
        avatarUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=user%20avatar%2011&image_size=square',
        nickName: '好友1',
        score: 600
      },
      {
        avatarUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=user%20avatar%2012&image_size=square',
        nickName: '好友2',
        score: 550
      },
      {
        avatarUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=user%20avatar%2013&image_size=square',
        nickName: '好友3',
        score: 500
      },
      {
        avatarUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=user%20avatar%2014&image_size=square',
        nickName: '好友4',
        score: 450
      },
      {
        avatarUrl: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=user%20avatar%2015&image_size=square',
        nickName: '好友5',
        score: 400
      }
    ],
  ...
  checkCheckinStatus() {
    ...
    const lastCheckin = wx.getStorageSync('lastCheckinDiancang');
  ...
  checkin() {
    ...
    setTimeout(() => {
      const today = new Date().toDateString();
      wx.setStorageSync('lastCheckinDiancang', today);
