  ...
  data: {
    ...
    towerList: [
      ...
      },
      {
        name: "小雁塔",
       : "陕西西安·唐代密檐式佛塔，秀挺古朴。",
        detail: "小雁塔始建于唐景龙年间，为唐代长安著名佛塔，通高43.4米，15层密檐式结构，造型秀丽挺拔，历经千年风雨与多次地震仍屹立不倒，体现了唐代高超的建筑抗震技术。",
      ...
      },
      {
        name: "雷峰塔",
       : "浙江杭州·西湖十景，吴越国建筑遗迹。",
        detail: "雷峰塔始建于北宋开宝五年，为吴越王钱俶所建，因《白蛇传》传说闻名天下。原塔倒塌后于2002年重建，新塔保留唐宋风格，是俯瞰西湖全景的绝佳之处。",
      ...
      },
      {
        name: "应县木塔",
       : "山西朔州·世界最高木塔，纯木结构无钉铆。",
        detail: "应县木塔全称佛宫寺释迦塔，始建于辽清宁二年，全塔纯木结构，无一根铁钉，通高67.31米，是世界现存最高最古老的木构塔式建筑，与比萨斜塔、埃菲尔铁塔并称世界三大奇塔。",
      ...
      },
      {
        name: "开封铁塔",
       : "河南开封·宋代琉璃砖塔，天下第一塔。",
        detail: "开封铁塔始建于北宋皇祐元年，因塔身以褐色琉璃砖砌筑，远望如铁铸而得名。塔高55.88米，八角十三层，历经千年地震、水患、战争完好如初，被誉为“天下第一塔”。",
      ...
      },
      {
        name: "黄鹤楼",
       : "湖北武汉·江南三大名楼，天下绝景。",
        detail: "黄鹤楼始建于三国吴黄武二年，自古享有“天下绝景”之称，与岳阳楼、滕王阁并称江南三大名楼。历代文人墨客在此留下千古名篇，登楼可俯瞰武汉三镇与长江全景。",
      ...
      },
      {
        name: "岳阳楼",
       : "湖南岳阳·江南三大名楼，先天下之忧而忧。",
        detail: "岳阳楼始建于东汉建安年间，因范仲淹《岳阳楼记》名扬天下，是江南三大名楼中唯一保持原貌的古建筑。楼体三层，纯木结构，俯瞰洞庭湖，气势壮阔。",
      ...
      },
      {
        name: "滕王阁",
       : "江西南昌·江南三大名楼，滕王阁序发源地。",
        detail: "滕王阁始建于唐永徽四年，因王勃《滕王阁序》闻名天下，“落霞与孤鹜齐飞，秋水共长天一色”写尽此处风光。楼阁高大宏伟，依山傍水，为江南古建筑典范。",
      ...
      },
      {
        name: "六和塔",
       : "浙江杭州·钱塘江畔古塔，镇潮护江。",
        detail: "六和塔始建于北宋开宝三年，为镇压钱塘江潮而建，塔高59.89米，八角十三层，楼阁式砖塔，登塔可远眺钱塘江大桥与六和潮景，是杭州重要古建筑。",
      ...
      },
      {
        name: "报恩寺塔",
       : "江苏苏州·中国最高古塔，九层琉璃宝塔。",
        detail: "报恩寺塔又称北寺塔，始建于三国吴赤乌年间，现存为南宋建筑，高76米，九层八面，是苏州现存最高古建筑，登上塔顶可俯瞰苏州全城。",
